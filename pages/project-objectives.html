...
page-sections:
- _page-sections/project-objectives.md
image: assets/img/img_20200122_084424.jpg

---
{% assign teams = site.objective-teams | sort: "page-order" %}
{% for team in teams %}
<h2>{{team.title}}</h2>
<p>{{ team.description}}</p>
    {% assign people_array = team.associated-people %}
